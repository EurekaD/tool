...
if __name__ == '__main__':
    xs, ys = create_datas()
    regressions = [Linear(xs, ys), Multinomial(xs, ys, n=6), Multinomial(xs, ys, n=7), Multinomial(xs, ys, n=8), Multinomial(xs, ys, n=9), Multinomial(xs, ys, n=10)]
